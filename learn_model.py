...
class CustomDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, states, actions, rewards, terminals, unroll_steps):
        self.states = states
        # self.actions_one_hot = F.one_hot(actions.long(), num_classes=num_actions)
...
def main(
    ...
    seed: int = 42,
    exp_name: str = "test",
    data_path: str = "data/experience_data_episode_21000.npz",
...
if __name__ == '__main__':
    ...
    main(exp_name=args.output, data_path=args.data)