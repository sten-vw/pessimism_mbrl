...
import os
import math
from mcts_LCB import Node, MCTS
...
def evaluate_episode(param):
        ...
        L_penalty = mcts_params["L_penalty"]
        ...
        with torch.inference_mode():
            ...
            while not done:
                ...
                best_action = MCTS(root, model, num_simulations, exploration_constant, discount_factor,
                                   planning_horizon, state_action_map, L_penalty)
...
def main(output_folder: str, model_folder: str, data_file: str, L_penalty:float, seed: int, num_episodes: int, true_model: bool = True, exploration_constant: float = 1.0, discount_factor: float = 0.97, planning_horizon: int = 32, num_simulations: int = 128):
